...
<header className="mt-5 bg-white p-8">
  <div className="w-full container mx-auto pt-12 pb-24 text-center">
    ...
    <div className="w-full bg-[#0089cf] p-8 rounded-lg shadow-lg flex items-center justify-center space-x-16">
      {/* Imagen */}
      <div className="flex-shrink-0">
        <Image
          src="/image/oncurarse.png" // Cambia la ruta de la imagen
